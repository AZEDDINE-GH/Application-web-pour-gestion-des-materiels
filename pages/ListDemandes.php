...
*/
   if($NumEtage=="all"){
     $requete="select * from demande where Utilisateur like '%$nomm%' 
     limit $size
                offset $offset";
     $requeteCount="select count(*) countM from demande where Utilisateur like '%$nomm%' ";
   }else{
      $requete="select * from demande
                ...
                limit $size
                offset $offset";
      $requeteCount="select count(*) countM from demande where Utilisateur like '%$nomm%'  and NumEtage='$NumEtage'";
   }
       ...
       <div class="inbox-bx container-fluid">
        ...
        <div class="panel panel-warning margetop50">
          ...
          <div class="panel-body">
              <form method="get" action="ListDemandes.php" class="form-inline">
        ...
        <div class="panel panel-info margetop50">
          ...
          <div class="panel-heading">
            Liste des Demandes (<?php echo $nbrMateriel ?> Demandes)
          </div>
          <div class="panel-body">
        <table class="table table-striped table-bordered" width="100px">
                        <thead>
                            <tr>
                                <th>ID</th> <th>Utilisateur</th> <th>N°etage</th><th>Type de materiel</th> <th>Date de Demande</th><th>msg</th><th>Quantite</th><th>Ma reponse</th>
                        ...
                        <tbody>
                            <?php while($demande=$resultatM->fetch()){ ?>
                                <tr>
                                    ...
                                    <td><?php echo $demande['NumEtage'] ?> </td> 
                                    <td><?php echo $demande['nomType'] ?> </td>
                                    <td><?php echo $demande['DateDemande'] ?> </td>
                                    <td><?php echo $demande['msg'] ?> </td>
                                    <centre><td><?php echo $demande['Quantite'] ?> </td></centre>
                                    <centre><td><?php echo $demande['msg_rep'] ?> </td></centre>
                                    ...
                                    <td>
                                   <center>  
                               <a href="reponsU.php?idM=<?php echo $demande['ID'] ?>">
                              <button type="submit" class="btn btn-success">
                  ...
                  affecter
                                   ...
                                   <!--<center> <a  onclick="return confirm('Etes vous sur de vouloir supprimer le materiele')"

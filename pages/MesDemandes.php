...
*/
  // if($NumEtage=="all"){
     $requete="select * from demande where Utilisateur  like '%$Utilisateur%'";
      $requeteCount="select count(*) countM from demande where Utilisateur  like '%$Utilisateur%'";
       ...
       <div class="inbox-bx container-fluid">
        ...
        <div class="panel panel-info margetop50">
          ...
          <div class="panel-heading">
            Liste de mes demandes (<?php echo $nbrMateriel ?> demande)
          </div>
          <div class="panel-body">
        <table class="table table-striped table-bordered" width="100px">
                        <thead>
                            <tr>
                                <th>ID</th> <th>Utilisateur</th> <th>Type de materiel</th> <th>Date de Demande</th><th>mon message</th><th>Quantite demande</th><th>repons Admin</th><th>Quantite envoyee</th>
                        ...
                        <tbody>
                            <?php while($demande=$resultatM->fetch()){ ?>
                                <tr>
                                    ...
                                    <td>
                                    <!--  <a href="editerMateriel.php?idM=<?php echo $demande['ID'] ?>">
                                  <span class="glyphicon glyphicon-edit"></span>
                                      </a>-->
                                &nbsp;
                                    <a  onclick="return confirm('Etes vous sur de vouloir supprimer la demande')"
                                    href="supprimerDemande.php?idD=<?php echo $demande['ID'] ?>">
